...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_UPD_PLAYER_FARM_PLOT_RESET,
    CHAR_UPD_PLAYER_FARM_PLOT_WATER,
    CHAR_UPD_PLAYER_FARM_PLOT_PESTS,
    CHAR_UPD_PLAYER_FARM_PLOT_REPAIR,
    CHAR_UPD_PLAYER_FARM_PLOT_STATE,
